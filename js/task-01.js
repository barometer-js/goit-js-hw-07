...
quantityCategories.forEach(quantityCategories => {
    const nameTitle = quantityCategories.querySelector('h2');
    console.log(`Категория: ${nameTitle.textContent}`);

    const quantityItems = quantityCategories.querySelectorAll('li');
